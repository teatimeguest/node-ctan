...
import type {
  ...
  PseudonymousAuthor,
  Topic,
} from '#/json/v2_0/responses';
import * as schemas from '#/json/v2_0/schemas';
...
export class Client extends ClientBase {
  ...
  async authors(
    ...
    return await this.get<Array<Author | PseudonymousAuthor>>(
      `/json/2.0/authors`,
  ...
  async author(
    ...
    return await this.get<Author | PseudonymousAuthor>(
      `/json/2.0/author/${key}`,
      buildParams(params, keys<AuthorParameters>()),
      schemas.Authors.items as JSONSchemaType<Author | PseudonymousAuthor>,
      config,
    );
  }
