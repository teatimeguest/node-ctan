...
|Name|Type|Description|
|---|---|---|
|»&nbsp;<var>\<anonymous></var>|[Author](../../../openapi/json/1.3.yml#L756)<br>`non-empty`|Information about an author.|
...
|»»&nbsp;`pkgs`|[string]<br>`unique`|List of ids of packages mentioning the author. This attribute is included if the query parameter `ref` is set to `true`.<p><blockquote>**:warning: Warning**:  This attribute is [documented](https://ctan.org/help/json/1.3/author) under the incorrect name `packages`.</blockquote></p>|

_xor_

|Name|Type|Description|
|---|---|---|
|»&nbsp;<var>\<anonymous></var>|[PseudonymousAuthor](../../../openapi/json/1.3.yml#L827)<br>`non-empty`|Information about a pseudonymous author.|
|»»&nbsp;`key`<br>$\textcolor{#D29922}{\textsf{required}}$|string<br>`non-empty`|The key of the author.|
|»»&nbsp;`died`<br>$\textcolor{#D29922}{\textsf{required}}$|boolean|The indicator that the author is deceased.|
...
|Name|Type|Description|
|---|---|---|
|<var>Topics</var>|[[Topic](../../../openapi/json/1.3.yml#L858)]|List of topics.|
|»&nbsp;<var>Topic</var>|[Topic](../../../openapi/json/1.3.yml#L858)<br>`non-empty`|Information about a topic.|
...
|»»&nbsp;`packages`|[string]<br>`unique`|The list of ids of packages referring to the topic. This attribute is included if the parameter `ref` is set to `true`.<p><blockquote>**:warning: Warning**:  This attribute is [documented](https://ctan.org/help/json/1.3/topic) under the incorrect name `references`.</blockquote></p>|
...
<div align="right"><sup>https://ctan.org/help/json/1.3/packages&nbsp;&#x29c9;</sup></div>
...
|Name|Type|Description|
|---|---|---|
|<var>Packages</var>|[[PackageSummary](../../../openapi/json/1.3.yml#L897)]|List of package summaries.|
|»&nbsp;<var>PackageSummary</var>|[PackageSummary](../../../openapi/json/1.3.yml#L897)<br>`non-empty`|Summary of a package.|
...
|»»&nbsp;`caption`<br>$\textcolor{#D29922}{\textsf{required}}$|string|A short descriptive text about the content of the package.<p><blockquote>**:warning: Warning**:  This attribute is [documented](https://ctan.org/help/json/1.3/packages) under the incorrect name `detailed`.</blockquote></p>|
...
|`drop`|query|[string]|<p><sup>Default: `[]`</sup><br> A comma separated list of fields to drop.</p><p><details><summary>Items Enum:</summary><p><div>`announce`, `authors`, `bugs`, `caption`, `copyright`, `ctan`, `descriptions`, `development`, `documentation`, `home`, `index`, `install`, `miktex`, `name`, `repository`, `support`, `texlive`, `topics`, `version`</div></p></details></p>|
...
|»&nbsp;`authors`<br>$\textcolor{#D29922}{\textsf{required}}$|[[PackageAuthor](../../../openapi/json/1.3.yml#L1048)]|The list of authors.|
|»»&nbsp;<var>PackageAuthor</var>|[PackageAuthor](../../../openapi/json/1.3.yml#L1048)<br>`non-empty`|Information about a package author.|
...
|»&nbsp;`copyright`|[[Copyright](../../../openapi/json/1.3.yml#L1062)]|The information about the copyright.|
|»»&nbsp;<var>Copyright</var>|[Copyright](../../../openapi/json/1.3.yml#L1062)<br>`non-empty`||
...
|Name|Type|Description|
|---|---|---|
|»»&nbsp;<var>\<anonymous></var>|[LicenseIdentifier](../../../openapi/json/1.3.yml#L1170)|<p>Identifier of a license.</p><p><details><summary>Enum:</summary><p><div>`apache2`, `artistic`, `artistic2`, `bsd`, `bsd2`, `bsd3`, `bsd4`, `cc-by-1`, `cc-by-2`, `cc-by-3`, `cc-by-4`, `cc-by-nc-1`, `cc-by-nc-2`, `cc-by-nc-3`, `cc-by-nc-4`, `cc-by-nc-nd-1`, `cc-by-nc-nd-2`, `cc-by-nc-nd-2.5`, `cc-by-nc-nd-3`, `cc-by-nc-nd-4`, `cc-by-nc-sa4`, `cc-by-nd-1`, `cc-by-nd-2`, `cc-by-nd-3`, `cc-by-nd-4`, `cc-by-sa-1`, `cc-by-sa-2`, `cc-by-sa-3`, `cc-by-sa-4`, `cc0`, `eupl`, `fdl`, `gfl`, `gfsl`, `gpl`, `gpl1`, `gpl1+`, `gpl2`, `gpl2+`, `gpl3`, `gpl3+`, `isc`, `knuth`, `lgpl`, `lgpl2.1`, `lgpl3`, `lppl`, `lppl1`, `lppl1.2`, `lppl1.3`, `lppl1.3a`, `lppl1.3b`, `lppl1.3c`, `mit`, `nocommercial`, `nosell`, `nosource`, `ofl`, `opl`, `other-free`, `other-nonfree`, `pd`, `shareware`, `x11`, `noinfo`</div></p></details></p>|

_xor_

|Name|Type|Description|
|---|---|---|
|»»&nbsp;<var>\<anonymous></var>|[[LicenseIdentifier](../../../openapi/json/1.3.yml#L1170)]<br>`unique`|<p>[Identifier of a license.]</p><p><details><summary>Items Enum:</summary><p><div>`apache2`, `artistic`, `artistic2`, `bsd`, `bsd2`, `bsd3`, `bsd4`, `cc-by-1`, `cc-by-2`, `cc-by-3`, `cc-by-4`, `cc-by-nc-1`, `cc-by-nc-2`, `cc-by-nc-3`, `cc-by-nc-4`, `cc-by-nc-nd-1`, `cc-by-nc-nd-2`, `cc-by-nc-nd-2.5`, `cc-by-nc-nd-3`, `cc-by-nc-nd-4`, `cc-by-nc-sa4`, `cc-by-nd-1`, `cc-by-nd-2`, `cc-by-nd-3`, `cc-by-nd-4`, `cc-by-sa-1`, `cc-by-sa-2`, `cc-by-sa-3`, `cc-by-sa-4`, `cc0`, `eupl`, `fdl`, `gfl`, `gfsl`, `gpl`, `gpl1`, `gpl1+`, `gpl2`, `gpl2+`, `gpl3`, `gpl3+`, `isc`, `knuth`, `lgpl`, `lgpl2.1`, `lgpl3`, `lppl`, `lppl1`, `lppl1.2`, `lppl1.3`, `lppl1.3a`, `lppl1.3b`, `lppl1.3c`, `mit`, `nocommercial`, `nosell`, `nosource`, `ofl`, `opl`, `other-free`, `other-nonfree`, `pd`, `shareware`, `x11`, `noinfo`</div></p></details></p>|
...
|Name|Type|Description|
|---|---|---|
|»&nbsp;`version`|[PackageVersion](../../../openapi/json/1.3.yml#L1074)<br>`non-empty`|Information about the version of a package.|
|»»&nbsp;`number`|string|The version number.|
|»»&nbsp;`date`|string|The version date.|
|»&nbsp;`descriptions`<br>$\textcolor{#D29922}{\textsf{required}}$|[[PackageDescription](../../../openapi/json/1.3.yml#L1086)]|Long descriptions of the package.|
|»»&nbsp;<var>PackageDescription</var>|[PackageDescription](../../../openapi/json/1.3.yml#L1086)|A long description of a package.|
|»»»&nbsp;`text`|string|The longer description of the package which may include HTML markup. An inner tag `<ref>` is used to reference a package with attribute `refid`.<p><blockquote>**:warning: Warning**:  This attribute is [documented](https://ctan.org/help/json/1.3/pkg) under the incorrect name `description`.</blockquote></p>|
|»»»&nbsp;`language`|string<br>`nullable`|The ISO code for the language of the description. Alternately it may be `null` to indicate the default language, i.e. English.<p><blockquote>**:warning: Warning**:  This attribute is [documented](https://ctan.org/help/json/1.3/pkg) under the incorrect name `lang`.</blockquote></p>|
|»&nbsp;`documentation`<br>$\textcolor{#D29922}{\textsf{required}}$|[[PackageDocumentation](../../../openapi/json/1.3.yml#L1136)]|List of references to documentation.|
|»»&nbsp;<var>PackageDocumentation</var>|[PackageDocumentation](../../../openapi/json/1.3.yml#L1136)||
|»»»&nbsp;`language`|string<br>`nullable`|The ISO code for the language of the description.<p><blockquote>**:warning: Warning**:  This attribute is [documented](https://ctan.org/help/json/1.3/pkg) under the incorrect name `lang`.</blockquote></p>|
...
|»&nbsp;`install`|string|The location of the package on CTAN relative to the CTAN directory `/install` in form of an installable TDS-compliant zip archive.<p><blockquote>**:warning: Warning**:  This attribute is incorrectly [documented](https://ctan.org/help/json/1.3/pkg) as having an `object` type.</blockquote></p>|
|»&nbsp;`miktex`|string|The name of the package in MiKTeX.<p><blockquote>**:warning: Warning**:  This attribute is incorrectly [documented](https://ctan.org/help/json/1.3/pkg) as having an `object` type.</blockquote></p>|
|»&nbsp;`texlive`|string|The name of the package in TeX Live.<p><blockquote>**:warning: Warning**:  This attribute is incorrectly [documented](https://ctan.org/help/json/1.3/pkg) as having an `object` type.</blockquote></p>|
...
|Name|Type|Description|
|---|---|---|
|<var>Licenses</var>|[[License](../../../openapi/json/1.3.yml#L1188)]|List of licenses.|
|»&nbsp;<var>License</var>|[License](../../../openapi/json/1.3.yml#L1188)<br>`non-empty`|Information about a license.|
|»»&nbsp;`key`<br>$\textcolor{#D29922}{\textsf{required}}$|[LicenseIdentifier](../../../openapi/json/1.3.yml#L1170)|<p>The key of the license.</p><p><details><summary>Enum:</summary><p><div>`apache2`, `artistic`, `artistic2`, `bsd`, `bsd2`, `bsd3`, `bsd4`, `cc-by-1`, `cc-by-2`, `cc-by-3`, `cc-by-4`, `cc-by-nc-1`, `cc-by-nc-2`, `cc-by-nc-3`, `cc-by-nc-4`, `cc-by-nc-nd-1`, `cc-by-nc-nd-2`, `cc-by-nc-nd-2.5`, `cc-by-nc-nd-3`, `cc-by-nc-nd-4`, `cc-by-nc-sa4`, `cc-by-nd-1`, `cc-by-nd-2`, `cc-by-nd-3`, `cc-by-nd-4`, `cc-by-sa-1`, `cc-by-sa-2`, `cc-by-sa-3`, `cc-by-sa-4`, `cc0`, `eupl`, `fdl`, `gfl`, `gfsl`, `gpl`, `gpl1`, `gpl1+`, `gpl2`, `gpl2+`, `gpl3`, `gpl3+`, `isc`, `knuth`, `lgpl`, `lgpl2.1`, `lgpl3`, `lppl`, `lppl1`, `lppl1.2`, `lppl1.3`, `lppl1.3a`, `lppl1.3b`, `lppl1.3c`, `mit`, `nocommercial`, `nosell`, `nosource`, `ofl`, `opl`, `other-free`, `other-nonfree`, `pd`, `shareware`, `x11`, `noinfo`</div></p></details></p>|
...
<div align="right"><sup>https://ctan.org/help/json/1.3/searching&nbsp;&#x29c9;</sup></div>
...
|»&nbsp;`hits`<br>$\textcolor{#D29922}{\textsf{required}}$|[[SearchHit](../../../openapi/json/1.3.yml#L1240)]|The list of hits in this junk.|
|»»&nbsp;<var>SearchHit</var>|[SearchHit](../../../openapi/json/1.3.yml#L1240)<br>`non-empty`|Search hit.|
...
|Name|Type|Description|
|---|---|---|
|»&nbsp;`version`<br>$\textcolor{#D29922}{\textsf{required}}$|string|<p>The version number as string.</p>Value: `1.3`|
